...
-- Mixes
insert into mixes (name, delete_fl, likes, dislikes)
values ('Персикой чай Nestea','N',0,0),('Яблоко + Папайя + Морковь','N',0,0),
('Клубника + Черная смородина + Кокос + Мята','N',0,0), ('Таёжный морc','N',0,0),
('Апельсин + Карамель + Клубника + Банан','N',0,0), ('Киви + Клубника + Лимон + Мята','N',0,0),
('Cola Vanilla','N',0,0), ('Морковь + Яблоко + Карри + Черный перец','N',0,0);
