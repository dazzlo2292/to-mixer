...
-- Mixes
insert into mixes (name, delete_fl)
values ('Персикой чай Nestea','N'),('Яблоко + Папайя + Морковь','N'),
('Клубника + Черная смородина + Кокос + Мята','N'), ('Таёжный морc','N'),
('Апельсин + Карамель + Клубника + Банан','N'), ('Киви + Клубника + Лимон + Мята','N'),
('Cola Vanilla','N'), ('Морковь + Яблоко + Карри + Черный перец','N');
