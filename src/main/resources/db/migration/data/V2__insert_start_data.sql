...
values ('Персикой чай Nestea','N','N',0,0),('Яблоко + Папайя + Морковь','N','N',0,0),
('Клубника + Черная смородина + Кокос + Мята','N','N',0,0), ('Таёжный морc','N','N',0,0),
('Апельсин + Карамель + Клубника + Банан','N','N',0,0), ('Киви + Клубника + Лимон + Мята','N','N',0,0),
('Cola Vanilla','N','N',0,0), ('Морковь + Яблоко + Карри + Черный перец','N','N',0,0);
